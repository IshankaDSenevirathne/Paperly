...
Want to help? Thanks so much and we truly appreciate your help, there's something to do for everybody!
...
The [issue tracker](https://github.com/IshankaDSenevirathne/Paperly/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/Paperly.git
    # Navigate to the newly cloned directory
    cd Paperly
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/IshankaDSenevirathne/Paperly.git
    ```
