...
export default function Navigation() {
  ...
  const [pageItems,setPageItems]=useState(navItems.subjectmenu);
  ...
  useEffect(()=>{
    if(url==="/"){
        setPageItems(navItems.home);
    }
    else if(url==="/subjectmenu"){
        setPageItems(navItems.subjectmenu);
    }
    else if(url==="/quizes"){
        setPageItems(navItems.quiz);
    }
    console.log(url)
  },[url])
  return (
