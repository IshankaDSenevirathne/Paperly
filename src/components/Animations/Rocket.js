...
export default function Rocket() {
    ...
    useEffect(()=>{
        ...
        tlParticles
                ...
                .to("#particle1", {y:390,duration:2,opacity:0,ease:Linear.easeNone})
                .to("#particle2", {y:170, duration:2,opacity:0,ease:Linear.easeNone},'-=1.3')
                .to("#particle3", {y:40, duration:2,opacity:0,ease:Linear.easeNone},'-=1.3')
                .to("#particle5", {y:290, duration:2,opacity:0,ease:Linear.easeNone},'-=2.5')
                .to("#particle6", {y:10, duration:2,opacity:0,ease:Linear.easeNone},'-=1.6')
                .to("#particle7", {y:40, duration:2,opacity:0,ease:Linear.easeNone},'-=1.8')
                .to("#particle8", {y:490, duration:2,opacity:0,ease:Linear.easeNone},'-=.2')
                .to("#particle6", {y:10, duration:2,opacity:0,ease:Linear.easeNone},'-=1.6')
                .to("#particle9", {y:500, duration:2,opacity:0,ease:Linear.easeNone},'+=0.1')
                .to("#particle10", {y:0, duration:2,opacity:0,ease:Linear.easeNone},'-=1')
                .to("#particle4", {y:10, duration:2,opacity:0,ease:Linear.easeNone},'-=2.5')
                .to("#particle11", {y:460, duration:2,opacity:0,ease:Linear.easeNone},'-=1.6')
                .to("#particle12", {y:390, duration:2,opacity:0,ease:Linear.easeNone},'-=3.6')
